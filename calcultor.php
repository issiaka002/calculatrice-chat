...
<body>
	...
	<main>
		<form  method="post">
			<div class="container">
			<div>
				<p id="affi" name="resultat" class='affiche'></p>
				<input type="hidden" name="repnse" value="">
			</div>
			<div>
				<div>
			...
			<div class="right activ" id="right">
					<h2 >Mode d'utilisation:</h2>
  					<p class="">QuickCal est un application vous permettant de faire des calculs scinetifiques et ensuite vous pouvez partager vos experiences en discutant avec les autres utilisateurs...</p>
					<p>Pour utiliser QuickCal vous pouvez taper ce que vous voulez calculer et puis taper sur 'egale' pour voir le resultat</p>
					<p>Pour calculer a nouveau taper sur 'del' pour effacer</p>
					<p>Pour utiliser les fonctions trigonometriques taper d'abord le valeur a rentrer dans la fonction puis taper la fonction pour voir le resultat...</p>
